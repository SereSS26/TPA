...
{
  if (side < 5) drawsqr(x, y, side);
  else {
    double s3 = side / 5;
    drawfig(x, y+s3, s3);		//NNE
    drawfig(x,y,s3);
    drawfig(x,y+s3,s3);
    drawfig(x,y+2*s3,s3);
    drawfig(x+s3,y+2*s3,s3);
    drawfig(x+2*s3,y+2*s3,s3);
    drawfig(x+3*s3,y+2*s3,s3);
    drawfig(x+4*s3,y+2*s3,s3);
    drawfig(x+4*s3,y+3*s3,s3);
    drawfig(x+4*s3,y+4*s3,s3);
    drawfig(x,y+4*s3,s3);
    drawfig(x+s3,y+4*s3,s3);
    drawfig(x+2*s3,y+4*s3,s3);
    drawfig(x+2*s3,y+3*s3,s3);
    drawfig(x+2*s3,y+2*s3,s3);
    drawfig(x+2*s3,y+s3,s3);
    drawfig(x+2*s3,y,s3);
    drawfig(x+3*s3,y,s3);
    drawfig(x+4*s3,y,s3);
  }
